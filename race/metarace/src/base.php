...
<head>
  <title>MetaCTF</title>
  <meta name="description" content="META CTF">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
       <a class="nav-link" href="download_user.php"> <?php echo($_SESSION["user"]->name); ?></a>
      </li>
      <li class="nav-item">
       <a class="nav-link" href="upload_user.php"> Upload User </a>
      </li>
